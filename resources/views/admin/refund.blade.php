                      ...
                      <li class="nav-item"><a class="nav-link dropdown-indicator" href="#nv-admin" data-bs-toggle="collapse" aria-expanded="true" aria-controls="nv-admin">
                        ...
                        <div class="parent-wrapper">
                          <ul class="nav collapse parent show" data-bs-parent="#e-commerce" id="nv-admin">
                            ...
                            <li class="nav-item"><a class="nav-link active" href="../../../apps/e-commerce/admin/refund.html" data-bs-toggle="" aria-expanded="false">
                  ...
                  <ul class="dropdown-menu">
                    <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="admin" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                      ...
                      <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item active" href="../../../apps/e-commerce/admin/refund.html">
            ...
            <div class="col-12 col-sm-auto flex-grow-1">
              <div class="row align-items-center flex-wrap gy-1">
                <div class="col-auto flex-grow-1">
                  <p class="text-body-secondary lh-sm mb-0">Customer IP : <a class="fw-bold ms-1" href="#!">2364847</a></p>
                </div>
                <div class="col-auto">
