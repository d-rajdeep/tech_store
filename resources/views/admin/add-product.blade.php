    ...
    <div class="content">
        ...
        <form class="mb-9">
            <div class="row g-3 flex-between-end mb-5">
                ...
                <div class="col-auto"><button class="btn btn-primary mb-2 mb-sm-0" type="submit">Publish Product</button>
                </div>
            </div>
            <div class="row g-5">
                <div class="col-12 col-xl-8">
                    ...
                    <div class="mb-6">
                        ...
                        <textarea class="form-control tinymce" name="content" placeholder="Write a description here..."
                            style="height: 8rem; border-radius: 0.5rem; border: 1px solid #dee2e6; padding: 1rem;">
                        </textarea>
                    </div>
                        ...
                        <div class="dz-preview d-flex flex-wrap">
                            <div class="border border-translucent bg-body-emphasis rounded-3 d-flex flex-center position-relative me-2 mb-2"
                                style="height:80px;width:80px;"><img class="dz-image"
                                    src="{{ asset('admin_assets/img/products/23.png') }}" alt="..."
                    ...
                    <div class="row g-0 border-top border-bottom">
                        <div class="col-sm-4">
                            <div class="nav flex-sm-column border-bottom border-bottom-sm-0 border-end-sm fs-9 vertical-tab h-100 justify-content-between"
                                role="tablist" aria-orientation="vertical"><a
                                    ...
                                    aria-controls="pricingTabContent" aria-selected="true"> <span
                                        class="me-sm-2 fs-4 nav-icons" data-feather="tag"></span><span
                                        class="d-none d-sm-inline">Pricing</span></a><a
                                    ...
                                    aria-controls="restockTabContent" aria-selected="false"> <span
                                        class="me-sm-2 fs-4 nav-icons" data-feather="package"></span><span
                                        class="d-none d-sm-inline">Inventory</span></a><a
                                    class="nav-link border-end border-end-sm-0 border-bottom-sm text-center text-sm-start cursor-pointer outline-none d-sm-flex align-items-sm-center"
                                    id="shippingTab" data-bs-toggle="tab" data-bs-target="#shippingTabContent"
                                    role="tab" aria-controls="shippingTabContent" aria-selected="false"> <span
                                        class="me-sm-2 fs-4 nav-icons" data-feather="truck"></span><span
                                        class="d-none d-sm-inline">Shipping</span></a><a
                                    class="nav-link border-end border-end-sm-0 border-bottom-sm text-center text-sm-start cursor-pointer outline-none d-sm-flex align-items-sm-center"
                                    id="productsTab" data-bs-toggle="tab" data-bs-target="#productsTabContent"
                                    role="tab" aria-controls="productsTabContent" aria-selected="false"> <span
                        ...
                        <div class="col-sm-8">
                            <div class="tab-content py-3 ps-sm-4 h-100">
                                ...
                                <!-- Inventory Tab -->
                                <div class="tab-pane fade" id="restockTabContent" role="tabpanel">
                                    <div class="card p-4">
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            <label for="gtin" class="form-label fw-bold">GTIN, UPC, EAN, or
                                                ISBN</label>
                                            <input type="text" id="gtin" class="form-control" placeholder="">
                                        </div>

                                        <div class="form-check mb-3">
                                            <input class="form-check-input" type="checkbox" id="trackStock">
                                            <label class="form-check-label fw-bold" for="trackStock">
                                                Track stock quantity for this product
                                            </label>
                                        </div>

                                        <div class="mb-3">
                                            <label class="fw-bold d-block mb-1">Stock status</label>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="stockStatus"
                                                    id="inStock" checked>
                                        ...
                                        <div class="form-check mb-0">
                                            <input class="form-check-input" type="checkbox" id="soldIndividually">
                                            <label class="form-check-label fw-bold" for="soldIndividually">
                                ...
                                <div class="tab-pane fade h-100" id="shippingTabContent" role="tabpanel"
                                    ...
                                    <div class="d-flex flex-column h-100">
                                        <h5 class="mb-3 text-body-highlight">Shipping Details</h5>
                                        <div class="flex-1">
                                            <!-- Weight -->
                                            <div class="mb-3">
                                            ...
                                            <!-- Dimensions -->
                                            <div class="mb-3">
                                                <label class="form-label fw-semibold">Dimensions (in)</label>
                                                <div class="row g-2">
                                                    <div class="col">
                                        ...
                                        <p class="fs-9 fw-semibold mb-0">
                                            See our <a class="fw-bold" href="#!">Delivery terms and conditions</a>
                                            for details.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="tab-pane fade" id="productsTabContent" role="tabpanel"
                                    ...
                                    <div class="mb-3">
                                        <div class="form-check"><input class="form-check-input" type="radio"
                                                ...
                                                Countries</label></div>
                                        <div class="ps-4" style="max-width: 350px;"><select class="form-select ps-4"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row gx-3">
                                        <div class="col-12 col-sm-6 col-xl-12">
                                            <div class="mb-4">
                                                <div class="d-flex flex-wrap mb-2">
                                                    <h5 class="mb-0 text-body-highlight me-2">All categories</h5>
                                                    <a class="fw-bold fs-9" href="#!">Add new category</a>
                                                </div>

                                                <div class="form-check mb-2">
                                                    <input class="form-check-input" type="checkbox" id="men-cloth"
                                                        name="categories[]" value="men-cloth">
                                                    <label class="form-check-label" for="men-cloth">Men's Clothing</label>
                                                </div>

                                                <div class="form-check mb-2">
                                                    <input class="form-check-input" type="checkbox" id="women-cloth"
                                                        name="categories[]" value="women-cloth">
                                                    <label class="form-check-label" for="women-cloth">Women's
                                                        Clothing</label>
                                                </div>

                                                <div class="form-check mb-2">
                                                    <input class="form-check-input" type="checkbox" id="kid-cloth"
                                                        name="categories[]" value="kid-cloth">
                                                    <label class="form-check-label" for="kid-cloth">Kid's Clothing</label>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-12 col-sm-6 col-xl-12">
                                            ...
                                            <div class="form-check mb-2">
                                                <input class="form-check-input" type="checkbox" id="tag-men-cloth"
                                                    name="tags[]" value="men-cloth">
                                                <label class="form-check-label" for="tag-men-cloth">Men's Clothing</label>
                                            </div>

                                            <div class="form-check mb-2">
                                                <input class="form-check-input" type="checkbox" id="tag-women-cloth"
                                                    name="tags[]" value="women-cloth">
                                                <label class="form-check-label" for="tag-women-cloth">Women's
                                                    Clothing</label>
                                            </div>

                                            <div class="form-check mb-2">
                                                <input class="form-check-input" type="checkbox" id="tag-kid-cloth"
                                                    name="tags[]" value="kid-cloth">
                                                <label class="form-check-label" for="tag-kid-cloth">Kid's Clothing</label>
                                            </div>
                                        </div>
